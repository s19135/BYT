...
public class Money implements Comparable{
	...
	public String toString() {
		return "Amount: " + (double)(amount/100) + ", in currency: [" + currency.getName() + "].";
	}
	...
	public Boolean equals(Money other) {
		return (amount == currency.valueInThisCurrency(other.amount, other.getCurrency()));
	}
	...
	public Money add(Money other) {
		return new Money((amount + currency.valueInThisCurrency(other.amount, other.getCurrency())), currency);
	}
	...
	public int compareTo(java.lang.Object o) {
		return universalValue() - ((Money) o).universalValue();
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		if (!getAmount().equals(money.getAmount())) return false;
